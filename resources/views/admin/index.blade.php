...
<section class="flex flex-col min-h-[60vh] max-w-lg mx-auto items-center">
    ...
    <div class="flex flex-grow flex-wrap content-center justify-between gap-y-15 gap-x-2">
        ...
        <p><a href="{{ route('admin.besteloverzicht') }}" class="text-teal-700 p-2 border border-2 rounded-md hover:text-teal-700 font-semibold">bestel overzicht</a></p>
        <p><a href="{{ route('bestellingen.open') }}" class="text-teal-700 p-2 border border-2 rounded-md hover:text-teal-700 font-semibold">Open bestellingen</a></p>
    </div>
